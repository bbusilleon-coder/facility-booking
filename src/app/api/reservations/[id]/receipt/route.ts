...
import { applyFreeRental, getFreeRentalReason, getRentalPricing } from "@/lib/rental-fee";
...
<p class="note">위 금액을 계룡대학습관 시설 사용료로 확인합니다.<br>${freeRentalReason === "admin" ? "관리자가 직접 신청한 예약으로 무상 대관이 적용되었습니다." : freeRentalReason === "konyang-university" ? "건양대학교 관련 신청으로 무상 대관이 적용되었습니다." : freeRentalReason === "senior" ? "계룡시니어 관련 신청으로 무상 대관이 적용되었습니다." : `기본 ${pricing.baseHours}시간 요금 및 초과 사용시간을 기준으로 자동 산정되었습니다.`}</p>
