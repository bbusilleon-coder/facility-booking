...
export default function AdminLoginPage() {
  ...
  if (checking) {
    return (
      <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "var(--background, #0a0a0a)", color: "var(--text-muted, #888)" }}>
        로그인 확인 중...
      </div>
    );
  }
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "var(--background, #0a0a0a)", padding: 24 }}>
      <div style={{ width: "100%", maxWidth: 360, background: "var(--card-bg, #1a1a1a)", borderRadius: 16, padding: 32 }}>
        <h1 style={{ fontSize: 24, fontWeight: 800, marginBottom: 8, color: "var(--foreground, white)" }}>관리자 로그인</h1>
        <p style={{ color: "var(--text-muted, #888)", marginBottom: 24, fontSize: 14 }}>시설물 예약 관리 시스템</p>
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ marginBottom: 16 }}>
            <label style={{ display: "block", marginBottom: 6, fontSize: 14, color: "var(--text-secondary, #aaa)" }}>아이디</label>
            <input
              type="text"
              value={username}
          ...
          <label style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 24, cursor: "pointer", fontSize: 14, color: "var(--text-secondary, #aaa)" }}>
